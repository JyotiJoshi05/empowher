...
public class EmpowHer_Bevents extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        listSEvents.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(EmpowHer_Bevents.this, ViewSRecords.class);
    ...
    private class GetHttpResponse extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            HttpService httpService = new HttpService(Constants.BASE_URL +"/db_files/b_events.php");
            try
            {
                    ...
                    if(result != null)
                    {
                        ...
                        try {
                            ...
                            for(int i=0; i<jsonArray.length(); i++)
                            {
                                ...
                                eventobject.s_title = object.getString("b_name");
                                eventobject.s_desc = object.getString("b_description");
                                eventobject.s_id = object.getString("b_id");
                                eventobject.s_link = object.getString("blinkforclick");
                                eventobject.s_org = object.getString("borganizer");
                                eventobject.s_cat = object.getString("bcategory");
                                eventobject.s_eligible = object.getString("beligible");
                                eventobject.s_deadline = object.getString("bdeadline");
