...
public class EmpowHer_Sevents extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        listSEvents.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(EmpowHer_Sevents.this, ViewSRecords.class);
    ...
    private class GetHttpResponse extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            HttpService httpService = new HttpService(Constants.BASE_URL +"db_files/s_events.php");
            try
            {
                    ...
                    if(result != null)
                    {
                        ...
                        try {
                            ...
                            for(int i=0; i<jsonArray.length(); i++)
                            {
                                ...
                                eventobject.s_title = object.getString("s_name");
                                eventobject.s_desc = object.getString("s_description");
                                eventobject.s_id = object.getString("s_id");
                                eventobject.s_link = object.getString("slinkforclick");
                                eventobject.s_org = object.getString("sorganizer");
                                eventobject.s_cat = object.getString("scategory");
                                eventobject.s_eligible = object.getString("seligible");
                                eventobject.s_deadline = object.getString("sdeadline");
